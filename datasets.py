...
def get_dataloaders_tinyimagenet(batch_size: int, size: int):
    ...
    train_dataset = TinyImageNet(
        "/share/chang.qi/tmp/tinyimagenet/", 
        split="train", 
        transform=t
        )
